...
namespace SEM.Win32
{
    ...
    public static class HandleExeHelper
    {
        ...
        public static List<HandleLockInfo> QueryLocks(string handleExePath, string targetPath)
        {
            ...
            // 示例：
            // rdpclip.exe        pid: 47900  type: File            40: C:\Users\Administrator\Desktop\bdaide\app
            // explorer.exe       pid: 17364  type: File          1A28: C:\Users\Administrator\Desktop\bdaide\app
            var regex = new Regex(
